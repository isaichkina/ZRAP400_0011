...
define view entity ZRAP400_I_BOOKING_0011
  as select from ZRAP400_BOOK0011
  association to parent ZRAP400_I_Travel_0011 as _Travel on $projection.TravelID = _Travel.TravelID
